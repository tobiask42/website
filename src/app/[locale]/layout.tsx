...
export default async function LocaleLayout(props: PageProps) {
  ...
  return (
    <NextIntlClientProvider locale={locale} messages={messages}>
      <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 bg-white text-blue-600 p-2 rounded">
        Zum Inhalt springen
      </a>
      ...
      <main id="main" role="main" className="min-h-screen pt-8 bg-gray-100 text-gray-900">{children}</main>
